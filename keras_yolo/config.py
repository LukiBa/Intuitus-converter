...
DATASET_DIR = pathlib.Path(__file__).absolute().parents[3] / 'Datasets/coco'
...
__C.YOLO.CLASSES              = str(DATASET_DIR / "coco.names")
...
__C.TRAIN.ANNOT_PATH          = str(DATASET_DIR /"train2017.txt")
...
__C.TRAIN.SECOND_STAGE_EPOCHS   = 1
...
__C.TEST.ANNOT_PATH           = str(DATASET_DIR / "Datasets/coco/val2017.txt")

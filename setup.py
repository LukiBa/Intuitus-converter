...
setup(name='intuitus_converter',
      ...
      test_requires=['numpy', 'wget', 'pathlib', 'json', 'bitstring', 'importlib', 'argparse', 'typing', 'scikit-learn', \
                    'idx2numpy', 'pandas', 'brewer2mpl', 'tensorflow>=2.1', 'torch>=1.8', 'torchsummary', 'matplotlib', 'tqdm', 'opencv-python>=4.4', 'easydict'],
      install_requires=['setuptools', 'numpy', 'wget', 'pathlib', 'bitstring', 'importlib', 'argparse', 'typing', 'scikit-learn', \
